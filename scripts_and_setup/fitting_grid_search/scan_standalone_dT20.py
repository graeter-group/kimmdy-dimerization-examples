...
runs = 3
quantum_yield_exp = 0.028
n_T = 20

# Read distances
distances_dT20 = {}
for i in range(1, runs+1):
    distances_dT20[f"Run {i}"] = read_distance_file(f"../../data/data_dT20/dT20_R{i}_MD_Distances.xvg")

# Read dihedrals
dihedrals_dT20 = {}
for i in range(1, runs+1):
    dihedrals_dT20[f"Run {i}"] = read_angle_file(f"../../data/data_dT20/dT20_R{i}_MD_Angles.xvg")
